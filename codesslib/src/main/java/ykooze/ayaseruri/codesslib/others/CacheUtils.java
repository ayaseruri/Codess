...
public class CacheUtils {
    ...
    public static <T extends Object & Serializable> void putDisk(String key, T t){
        initMemoryCache();
        sMemoryCache.put(key, t);
        SerializeUtils.serialization(key, t);
    }

    public static Object get(String key, boolean delete){
        initMemoryCache();
        if(sMemoryCache.containsKey(key)){
            ...
            Object object = null;
            try {
                 object = SerializeUtils.deserializationSync(key, delete);
    ...
    public static void delete(String key){
        ...
        try {
            SerializeUtils.deserializationSync(key, true);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
